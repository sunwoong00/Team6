...
{
  "위험": True,
  "요약": "광화문에서 대규모 집회로 인해 혼잡하고 불안감을 느낄 수 있지만, 위험을 인지하지 못하고 계속 이동하려고 하고 있습니다. 상황이 안전하지 않을 수 있으니 혼잡 지역을 피하거나 신중히 행동하세요."
}
...
답변: {"요약":"차가 보인다면, 길을 건너지 말고 안전한 장소에서 보호자에게 전화하세요. 절대로 혼자 판단하지 말고, 대기하세요."}

예시 질문 2: "음료수 두 개 중 뭘 마실지 모르겠어요. 한 개는 주스이고, 다른 한 개는 탄산음료예요."
답변: {"요약":"주스는 건강에 더 좋을 수 있고, 탄산음료는 시원하고 청량한 느낌을 줄 거예요. 당신이 원하는 기분에 따라 선택하면 좋겠어요!"}
...
def rag_response_1(summary_text):
    engine = RetrievalEngine(demo_data_path='C:\\Users\\shyun\\Desktop\\realthon\\Team6\\AI\\new_infor.json')
    query = summary_text
